...
public final class Constants {
    // Falcon raw velocity to rpm conversion factor
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.2921; // FIXME Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.2921; // FIXME Measure and set wheelbase
